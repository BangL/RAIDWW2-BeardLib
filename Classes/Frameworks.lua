...
FrameworkBase._ignore_folders = {["base"] = true, ["BeardLib"] = true,["RAIDWW2-BeardLib-master"] = true, ["RAIDWW2-BeardLib"] = true, ["PAYDAY-2-BeardLib-master"] = true, ["downloads"] = true, ["logs"] = true, ["saves"] = true}
